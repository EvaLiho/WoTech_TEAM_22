...
// Create an object (new class, cheese or wine or whatever) in the endpoint, fill the object, access it from the URL
...
public class DatoriumApiApplication {
	...
	@GetMapping("/array2")
	public int[] array(@RequestParam(value = "number1") int number1, @RequestParam(value = "number2") int number2){
